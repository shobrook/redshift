try:
    ...
    from redshift.agent.tools.print_names import PrintNamesTool, NamesResult
except ImportError:
    ...
    from agent.tools.print_names import PrintNamesTool, NamesResult
